        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <th class="col-sm-2">Work</th>
              <th class="col-sm-8">Queue</th>
            </tr>
          </thead>
          <tbody>
            @if($user_works)
      ...
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          <ul class="list-inline sort_list client_sortable_list" id="client_dropable" data-area="client">
              ...
              <li class="project-{!! $work->id !!}
                @if($tl_id != $work->project_manager) ignore-elements @else item-elements @endif" data-pid="{!! $work->id !!}">
                <div class="panel">
                  <div class="panel-heading" style="background-color: {!! $work->projectmanager->color_code !!};">
               ...
               <div class="row working-data-row">
                   <div class="col-md-2">
                       ...
                       <button class="popper project-content" data-toggle="popover"><span
                        ...
                        <div class="popper-content hide">
                            <h5 class="pop-heading">I am the leader of this projects. <span class="glyphicon glyphicon-remove removePopover" id="remove"></span></h5>
                            {{-- <h5 class="pop-heading">I am the leader of this projects. <span><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a></span></h5> --}}
                            {{-- <h5 class="pop-heading">I am the leader of this projects. <span><a class="close removePopover" aria-label="close" id="removePopover">&times;</a></span></h5> --}}
                            @if(count($user->leader))
                                <ul>
                                    @foreach($user->leader as $project_leader)
                                        <li>{{ $project_leader->project_no.' '.$project_leader->project_text }}</li>
