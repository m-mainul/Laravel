					        	...
					        	if ($mytime->format('D') == 'Sat' || $mytime->format('D') == 'Sun') {
					        		...
					        		if (count($works)){				        			
					        			foreach ($works as $work)
					        				$output .= '<span style="background-color:'.$work->project->projectmanager->color_code .';color:'.$work->project->projectmanager->font_color.'">'.$work->project->project_no.' '.$work->project->project_text.'</span>'.'<br>';
					        		}
					        		echo '<td>';
					        		if ($output)
					        			echo $output; 
