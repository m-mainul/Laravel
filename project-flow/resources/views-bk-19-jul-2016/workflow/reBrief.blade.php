<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Re Brief</h4>
</div>
<div class="modal-body">
    <form action="{{route('brief',$id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                {!! Form::select('leader_id', $leader_options, $project->leader_id, ['class' => 'form-control','id'=>'leader_id','required' => 'required'])!!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class='input-group date_picker'>
                    {!! Form::text('start_time', date("d-F-Y", strtotime($old_brief->start_time)), array('id'=>'start_time','class' => 'form-control','required' => 'required')) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class='input-group date_picker'>
                    {!! Form::text('next_deadline', date("d-F-Y", strtotime($old_brief->next_deadline)), array('id'=>'next_deadline','class' => 'form-control','required' => 'required')) !!}
                    <span class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar">
                                </span>
                            </span>
