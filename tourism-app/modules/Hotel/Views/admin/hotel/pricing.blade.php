    ...
    <div class="panel">
        ...
        <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" name="price" class="form-control" value="{{$translation->price}}" placeholder="{{__("Hotel Price")}}">
                        </div>
                    </div>
                    <div class="col-lg-6 d-none">
                        <div class="form-group">
                            <label class="control-label">{{__("Sale Price")}}</label>
                            <input type="number" step="any" name="sale_price" class="form-control" value="{{$translation->sale_price}}" placeholder="{{__("Hotel Sale Price")}}">
         ...
         <!--       <div class="form-group @if(!is_default_lang()) d-none @endif"> -->
				<div class="form-group"> 
                    <label><input type="checkbox" name="enable_extra_price" @if(!empty($translation->enable_extra_price)) checked @endif value="1"> {{__('Enable extra price')}}
                    </label>
                </div>
		 <!--   <div class="form-group-item @if(!is_default_lang()) d-none @endif" data-condition="enable_extra_price:is(1)"> -->
                <div class="form-group-item" data-condition="enable_extra_price:is(1)">
                    ...
                    <div class="g-items">
                    @if(!empty($translation->extra_price))
                        @foreach($translation->extra_price as $key=>$extra_price)
            ...
            {{--  @if((!empty(setting_item("hotel_allow_vendor_can_add_service_fee")) or is_admin())) --}} 
                <hr>
                <h3 class="panel-body-title app_get_locale">{{__('Service fee')}}</h3>
                <div class="form-group app_get_locale">
                    <label><input type="checkbox" name="enable_service_fee" @if(!empty($translation->enable_service_fee)) checked @endif value="1"> {{__('Enable service fee')}}
                    </label>
                </div>
                <div class="form-group-item" data-condition="enable_service_fee:is(1)">
                    ...
                    <div class="g-items">
                        ...
                        @if(!empty($service_fee = $translation->service_fee))
