            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" min="0" name="number" class="form-control" value="{{$translation->number}}" placeholder="{{__("Car Number")}}">
                    </div>
					</div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Price")}}</label>
                        <input type="number" step="any" min="0" name="price" class="form-control" value="{{$translation->price}}" placeholder="{{__("Car Price")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Sale Price")}}</label>
                        <input type="number" step="any" name="sale_price" class="form-control" value="{{$translation->sale_price}}" placeholder="{{__("Car Sale Price")}}">
