...
use App\User;
use Modules\Booking\Emails\RequestQuoteSendEmail;
use Modules\Booking\Events\RequestQuoteSendEvent;
use Illuminate\Support\Facades\Mail;


class RequestQuoteSendListen
{
     ...
     * Handle the event.
     *
     * @param RequestQuoteSendEvent $event
     * @return void
     */
    public function handle(RequestQuoteSendEvent $event)
    {
