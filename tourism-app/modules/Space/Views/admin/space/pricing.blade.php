            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" min="0" name="price" class="form-control" value="{{$translation->price}}" placeholder="{{__("Space Price")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Sale Price")}}</label>
                        <input type="number" step="any" name="sale_price" class="form-control" value="{{$translation->sale_price}}" placeholder="{{__("Space Sale Price")}}">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" name="max_guests" class="form-control" value="{{$translation->max_guests}}" >
                    </div>
                </div>
            </div>
      {{--   @endif --}}
