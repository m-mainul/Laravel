...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'TZ Tourism'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Tanzania Tourism by')}} <a href="{{__('https://one2oneconsultant.com')}}" target="_blank">{{__('One Two One Consultant Team')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://one2oneconsultant.com')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://m.me/one2oneconsultantltd')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
