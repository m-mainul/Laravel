    ...
    public function run()
    {
        ...
        DB::table('core_settings')->insert(
            [
                ...
                [
                    'name'  => 'admin_email',
                    'val'   => 'info@one2oneconsultant.com',
                    'group' => "general",
                ], [
...
<a href="mailto:info@one2oneconsultant.com">info@one2oneconsultant.com</a>',
                    'group' => "general",
                ],
                [
                    'name'  => 'footer_text_left',
                    'val'   => 'Copyright © 2019 by Tanzania Tourism',
                    'group' => "general",
                ],
                [
                    'name'  => 'footer_text_right',
                    'val'   => 'Tanzania Tourism',
                    'group' => "general",
                ],
                [
...
<p>This document was last updated on October 6, 2020</p>';
        ...
        DB::table('core_settings')->insert([
                ...
                [
                    'name'  => "email_header",
                    'val'   => '<h1 class="site-title" style="text-align: center">Tanzania Tourisme</h1>',
                    'group' => "general",
                ],
                [
                    'name'  => "email_footer",
                    'val'   => '<p class="" style="text-align: center">&copy; 2021 Tanzania Tourism. All rights reserved</p>',
                    'group' => "general",
                ],
                [
