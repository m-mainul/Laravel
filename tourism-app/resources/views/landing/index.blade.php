...
<head>
    <meta charset="UTF-8"/>
    <title>One Two One Consultant Ltd - Tanzania Tourism</title>
            ...
            <div class="row">
                <div class="col-xs-3">
                    <h1><a target="_blank" href="{{url('intro')}}"><img src="{{url('images')}}/logo.svg"
                                                                 alt="Tanzania Tourism Logo"/></a></h1>
                </div>
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="https://www.facebook.com/one2oneconsultant/" target="_blank">Support</a>
                            <a target="_blank" class="dropdown-item" href="http://one2oneconsultant.com">Documentation</a>
                            <a target="_blank" href="{{config('landing.item_url')}}" class="dropdown-item btn-buynow">LEARN MORE</a></li>
                        </div>
                    </div>
                    <ul class="menu">
                        <li>
                            <a target="_blank" href="{{config('landing.item_url')}}" class="btn-buynow">LEARN MORE</a></li>
                        <li><a target="_blank" href="https://www.facebook.com/one2oneconsultantltd/">Support</a></li>
                        <li><a target="_blank" href="http://one2oneconsultant.com">Documentation</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        ...
        <div class="social">
            <span>FOLLOW US</span>
            <ul>
                <li><a target="_blank" href="https://www.facebook.com/one2oneconsultantltd/"><svg width="10" height="19" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li><a href="mailto:info@one2oneconsultant.com"><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
