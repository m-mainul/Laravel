		...
		<ul class="nav nav-tabs tabs-colored">
			<li class="active"> 
				<a href="#business_description" data-toggle="tab" aria-expanded="false"> 
					...
					<span class="hidden-xs">Buyer’s Profile</span> 
				</a> 
			</li>
			<li class=""> 
				...
				<div class="panel panel-default panel-lead">
					<div class="panel-body clearfix">
						<div class="panel-heading clearfix">
							<h4 class="panel-title pull-left">Buyer’s Profile</h4>
						</div>
					</div>
				</div>
				<div class="row">
								...
								<div class="form-col-2 form-col">
									<div class="row clearfix">
										<div class="col-md-12">
											...
											<div class="form-group col-md-6">
												<label class="col-md-4 control-label">Buyer’s Name:</label>
												<div class="col-md-8">
													<input type="text" class="form-control"/>
												</div>
											</div>
					...
					<div class="col-md-12">
						<div class="panel panel-default panel-lead">
							<form class="form-horizontal" role="form">
									...
									<div class="row clearfix">
										<div class="form-col form-col-6">
											<div class="form-group bgf3">
												...
												<div class="col-md-6">
													<label class="col-md-6 control-label">Buyer’s  Name: </label>
													<div class="col-md-6">
														<input type="text" class="form-control"/>
													</div>
												</div>
								...
								<div class="panel-heading clearfix">
									<h3 class="panel-title pull-left">Seller’s Profile:</h3>
								</div>
								<div class="panel-body clearfix">
									<div class="row clearfix">
										<div class="form-col form-col-6">
											<div class="form-group bgf3">
												<div class="col-md-6">
													<label class="col-md-6 control-label">Seller’s Profile:  </label>
													<div class="col-md-6">
														<input type="text" class="form-control"/>
													</div>
												</div>
								...
								<div class="panel-heading clearfix">
									<h3 class="panel-title pull-left">Confidentiality Agreement::</h3>
								</div>
								<div class="panel-body clearfix">
									<div class="row clearfix">
										<div class="form-col form-col-6">
											...
											<div class="form-group bgf9">
												<div class="col-md-6">
													<label class="col-md-6 control-label">Buyer’s Address:  </label>
													<div class="col-md-6">
														<input type="text" class="form-control"/>
													</div>
												</div>
